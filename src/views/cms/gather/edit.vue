<template>
  <div class="mb-20 bg-fff pd-20">
    <el-form ref="formRef" :model="params" label-width="84px">
      ...
      >
        <el-input v-model="params.taskName" placeholder="例：前端库-chat问答"></el-input>
      </el-form-item>
      ...
      >
        <div class="flex w-full">
          <el-input
            ...
            "
          ></el-input>
          <el-button class="ml-5" type="primary" @click="testParseFunction">测试</el-button>
        </div>
      </el-form-item>
...
async function testParseFunction() {
  try {
    ...
    let res = await getArticle({ targetUrl, parseData });
    if (res.code == 200) {
