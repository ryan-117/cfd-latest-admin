...
export let tinymceSet = {
  ...
  extended_valid_elements:
    'i[class],a[referrerpolicy|href|target|title|class|id|style],img[referrerpolicy|src|alt|width|height|class|id|style]', //允许a标签
  // 可选：如果你希望 TinyMCE 不对内容做任何清理，可以设置为 true（不推荐，可能有安全风险）
  //verify_html: false,
  // 可选：自定义有效规则（更高级用法）
  valid_elements: "*[*]", // 表示允许所有元素和所有属性（慎用）
  // 或者更精细地控制：
  //valid_elements: "i[class],+div[*],p[*],br,a[*],img[*],b,strong,em",
}
